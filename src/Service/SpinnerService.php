...
class SpinnerService
{
    public function createGame(ManagerRegistry $registry){
        ...
        (new SpinnerRecordsRepository($registry))->save(new SpinnerRecords());
    ...
    public function getParticipants(ManagerRegistry $registry, int $game_id){
        ...
        foreach($players as $player){
            $player_info = (new AccountProfileRepository($registry))->find($player->getId());
    ...
    public function getWinner(ManagerRegistry $registry, int $game_id){
        ...
        $update_record = (new SpinnerRecordsRepository($registry))->findOneBy(["game_id"=>$game_id]);
